...
#define CONCEPT_ARG(Concept)                                                                                             \
    ([]<typename PlaceholderT_##Concept>()->PlaceholderT_##Concept & requires Concept<PlaceholderT_##Concept> {          \
                                                                         return std::declval<PlaceholderT_##Concept&>(); \
                                                                     }.template operator()<struct Ghost_##Concept>())
