...
suite net_telnet_option_unit_tests = [] {
    using net::telnet::option;
    using net::telnet::negotiation_direction;

    "option stores id and name"_test = [] {
    ...
    "default predicates reject"_test = [] {
    ...
    "implicit conversion to id_num works"_test = [] {
        option opt{option::id_num::echo};
