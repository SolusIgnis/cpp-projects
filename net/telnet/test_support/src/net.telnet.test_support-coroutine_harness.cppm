...
export namespace net::telnet::test_support::coroutine_harness {
    ...
    public:
        ...
        struct aliasing_awaiter {
            ...
            template<typename U>
            [[nodiscard]] auto await_suspend(std::coroutine_handle<test_promise<U>> awaiting_handle) -> std::coroutine_handle<promise_type> noexcept
            {
            ...
            [[nodiscard]] auto await_suspend(std::coroutine_handle<> awaiting_handle) -> std::coroutine_handle<promise_type> noexcept
            {
                my_handle.promise().continuation = awaiting_handle;
                return my_handle;
            }
