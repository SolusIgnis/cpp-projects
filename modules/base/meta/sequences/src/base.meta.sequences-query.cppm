...
namespace base::meta::sequences {
     ...
     */
    template<auto LHS, auto RHS>
    inline constexpr bool uniform_equivalent_v =
        (LHS == RHS);
} //namespace base::meta::sequences
...
namespace base::meta::sequences {
    ...
    struct contains_type<type_list<Values...>, Query>
        : std::bool_constant<
            (std::same_as<Query, Values> || ...)
        > {};
    ...
    struct contains_value<uniform_value_list<T, Values...>, Query>
        : std::bool_constant<
            (uniform_equivalent_v<Query, Values> || ...)
        > {};
...
namespace base::meta::sequences {
    ...
    struct count_type_if<type_list<Elements...>, UnaryTypePredicate>
        : std::integral_constant<std::size_t,
            (0 + ... + (UnaryTypePredicate<Elements>::value ? 1 : 0))
        > {};
    ...
    struct count_value_if<value_list<Elements...>, UnaryValuePredicate>
        : std::integral_constant<std::size_t,
            (0 + ... + (UnaryValuePredicate<Elements>::value ? 1 : 0))
        > {};
    ...
    inline constexpr std::size_t count_type_if_v =
        count_type_if<std::remove_cvref_t<Seq>, UnaryTypePredicate>::value;
...
namespace base::meta::sequences {
    ...
    struct count_type<type_list<Elements...>, Query>
        : std::integral_constant<std::size_t,
            (0 + ... + (std::same_as<Query, Elements> ? 1 : 0))
        > {};
    ...
    struct count_value<value_list<Elements...>, Query>
        : std::integral_constant<std::size_t,
            (0 + ... + (value_equivalent_v<Query, Elements> ? 1 : 0))
        > {};

    template<typename T, T... Elements, T Query>
    struct count_value<uniform_value_list<T, Elements...>, Query>
        : std::integral_constant<std::size_t,
            (0 + ... + (uniform_equivalent_v<Query, Elements> ? 1 : 0))
        > {};

    export template<TypeSequence Seq, typename Query>
    inline constexpr std::size_t count_type_v =
        count_type<std::remove_cvref_t<Seq>, Query>::value;

    export template<ValueSequence Seq, auto Query>
    inline constexpr std::size_t count_value_v =
        count_value<std::remove_cvref_t<Seq>, Query>::value;
...
namespace base::meta::sequences {
    ...
    struct any_of_type<type_list<Elements...>, UnaryTypePredicate>
        : std::bool_constant<
            (false || ... || UnaryTypePredicate<Elements>::value)
        > {};
    ...
    struct any_of_value<value_list<Elements...>, UnaryValuePredicate>
        : std::bool_constant<
            (false || ... || UnaryValuePredicate<Elements>::value)
        > {};
    ...
    struct all_of_type<type_list<Elements...>, UnaryTypePredicate>
        : std::bool_constant<
            (true && ... && UnaryTypePredicate<Elements>::value)
        > {};
    ...
    struct all_of_value<value_list<Elements...>, UnaryValuePredicate>
        : std::bool_constant<
            (true && ... && UnaryValuePredicate<Elements>::value)
        > {};
    ...
    export template<TypeSequence Seq, template<typename> typename UnaryTypePredicate>
    inline constexpr bool any_of_type_v =
        any_of_type<std::remove_cvref_t<Seq>, UnaryTypePredicate>::value;

    export template<ValueSequence Seq, template<auto> typename UnaryValuePredicate>
    inline constexpr bool any_of_value_v =
        any_of_value<std::remove_cvref_t<Seq>, UnaryValuePredicate>::value;

    export template<TypeSequence Seq, template<typename> typename UnaryTypePredicate>
    inline constexpr bool all_of_type_v =
        all_of_type<std::remove_cvref_t<Seq>, UnaryTypePredicate>::value;

    export template<ValueSequence Seq, template<auto> typename UnaryValuePredicate>
    inline constexpr bool all_of_value_v =
        all_of_value<std::remove_cvref_t<Seq>, UnaryValuePredicate>::value;
