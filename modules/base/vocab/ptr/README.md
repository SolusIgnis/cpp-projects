...
This does not include raw pointers or vocabulary pointers as the destruction of the non-owning pointer can't make the constructed or assigned-to pointer dangle.
