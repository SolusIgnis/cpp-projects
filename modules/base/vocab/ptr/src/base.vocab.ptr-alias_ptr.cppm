...
export namespace base::vocab::inline ptr {
    ...
    public:
        ...
        constexpr alias_ptr& assign(const Pointer<Element, Args...>& source)
        {
            address_ = source.get();
            return *this;
        }
        ...
        alias_ptr& assign(const Pointer<Element, Args...>&&) =
     ...
     */
    /**
     * @overload alias_ptr& alias_ptr::assign(const Pointer<Element, Args...>& source)
     *
     * @tparam Pointer A class template modeling a pointer-like type.
     * @tparam Element The element type of the source pointer.
     * @tparam Args Additional template parameters of the pointer type.
