...
export namespace base::vocab::inline ptr {
    ...
    class iterator_ptr final
        : public ptr_core<iterator_ptr, Pointee, ptr_policies::type_list<ptr_policies::nullability::nullable, ptr_policies::pointer_binding::allowed, ptr_policies::reference_binding::allowed, ptr_policies::traversal::arithmetic>> {
    private:
