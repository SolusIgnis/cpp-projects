...
export namespace base::vocab::inline ptr {
    ...
    constexpr Pointer<Pointee> pointer_to(Pointee& object) noexcept(
        noexcept(std::pointer_traits<Pointer<Pointee>>::pointer_to(object))
        && std::is_nothrow_convertible_v<decltype(std::pointer_traits<Pointer<Pointee>>::pointer_to(object)), Pointer<Pointee>>
    )
    {
