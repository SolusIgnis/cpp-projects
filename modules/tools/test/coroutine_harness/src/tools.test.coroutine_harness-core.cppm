...
export namespace tools::test::coroutine_harness {
    ...
    public:
         ...
         */
        ~coroutine_handle_manager() noexcept(
            false
        ) //NOLINT(bugprone-unsafe-to-allow-exceptions): This test support fixture uses a destructor exception to catch an otherwise undetectable class of test failures.
        {
            if (handle_) {
